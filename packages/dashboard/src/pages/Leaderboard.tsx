import {
  ...
  export default function Leaderboard() {
    ...
    // Sort by power usage in ascending order (least power used first)
    ...
    // Define different shades of blue for section backgrounds
    const teamColors = {
      "ML Engineers": "bg-gradient-to-r from-blue-600 to-blue-500", // Darker blue gradient
      "HR Team": "bg-gradient-to-r from-blue-500 to-blue-400", // Medium blue gradient
      "Mobile Developers": "bg-gradient-to-r from-blue-400 to-blue-300", // Lighter blue gradient
    };
  
    // Define table header colors matching each section's background
    const tableHeaderColors = {
      "ML Engineers": "bg-blue-700", // Dark blue for ML Engineers section
      "HR Team": "bg-blue-600",      // Slightly lighter blue for HR Team
      "Mobile Developers": "bg-blue-500", // Even lighter blue for Mobile Developers
    };
      ...
      <div className="py-12 bg-gradient-to-r from-blue-500 to-indigo-600">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-4xl font-bold text-center mb-8 text-white">
            Employee Power & Carbon Usage Leaderboard
          </h1>
          ...
          {teams.map((team, index) => (
            <div key={index} className={`mb-16 p-4 rounded-xl ${teamColors[team.name as keyof typeof teamColors]}`}>
              ...
              <div className="overflow-x-auto rounded-lg shadow-lg">
                <table className="min-w-full table-auto border-collapse border-4 border-white text-white">
                  <thead className={tableHeaderColors[team.name as keyof typeof tableHeaderColors]}>
                    <tr>
                  ...
                  <tbody className="bg-blue-900/10"> {/* Subtle blue gradient background for table rows */}
