  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-gray-50">
      ...
      <div className="w-full flex justify-center my-2">
        <img src={logo} alt="Site Logo" className="w-[500px] object-contain" />
      </div>
      ...
      <div className="relative">
        ...
        <div
          ...
          style={{ top: "61%", left: "47%", transform: "translateX(-50%)" }}
        >
          <button
        ...
        {leftBoxOpen && (
          <div
            className="absolute top-1/2 -translate-y-1/2 w-60 h-60 bg-blue-500 text-white border shadow-xl p-4 rounded-xl z-10"
            style={{ left: "-260px" }}
          >
